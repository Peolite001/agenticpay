...
export function TimezoneSettingsModal({
  ...
  // ✅ derive initial value safely
  const initialTimeZone = useMemo(
    () => resolveTimeZone(storedTimeZone),
    [storedTimeZone]
  );

  const [localTimeZone, setLocalTimeZone] =
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose how dates and times are shown across your
            dashboard.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Use a valid IANA timezone, like `Africa/Lagos`
